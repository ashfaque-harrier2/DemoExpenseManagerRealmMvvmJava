...
public class AccountsAdapter extends RecyclerView.Adapter<AccountsAdapter.AccountsViewHolder> {
	...
	public AccountsAdapter(Context context, List<Account> accountArrayList, AccountsClickListener accountsClickListener) {
	...
	public void onBindViewHolder(@NonNull AccountsViewHolder holder, int position) {
		...
		holder.itemView.setOnClickListener(c -> accountsClickListener.onAccountSelected(account));
	}
